...
namespace Blog_Tracker.Controllers
{
    public class BlogInfoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BlodId,Title,Subject,BlogUrl,EmpEmailId,DateOfCreation")] BlogInfo blogInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BlodId,Title,Subject,BlogUrl,EmpEmailId,DateOfCreation")] BlogInfo blogInfo)
        {
            if (ModelState.IsValid)
            {
