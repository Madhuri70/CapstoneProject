...
namespace Blog_Tracker.Controllers
{
    public class EmpInfoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmailId,Name,PassCode,DateOfJoining")] EmpInfo empInfo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmailId,Name,PassCode,DateOfJoining")] EmpInfo empInfo)
        {
            if (ModelState.IsValid)
            {
